...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    role: Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    type: Attribute.Enumeration<['producer', 'normal', 'admin', 'validator']>;
    name: Attribute.String;
    productoras: Attribute.Relation<
      'plugin::users-permissions.user',
      'manyToMany',
...
export interface ApiEarningEarning extends Schema.CollectionType {
  ...
  attributes: {
    ...
    event: Attribute.Relation<
      ...
      'api::event.event'
    >;
    currency: Attribute.Enumeration<['UYU', 'USD']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiEventEvent extends Schema.CollectionType {
  ...
  attributes: {
    ...
    ticket_types: Attribute.Relation<
      'api::event.event',
      'oneToMany',
      'api::ticket-type.ticket-type'
    >;
    description: Attribute.Text;
    type: Attribute.Enumeration<['normal', 'producer']>;
    status: Attribute.Enumeration<['Aprobado', 'Rechazado']>;
    total_tickets: Attribute.Integer;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiProducerProducer extends Schema.CollectionType {
  ...
  attributes: {
    ...
    rut: Attribute.Integer;
    users: Attribute.Relation<
      'api::producer.producer',
      'manyToMany',
      'plugin::users-permissions.user'
    >;
    Comision: Attribute.Decimal & Attribute.DefaultTo<12.8>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiTicketTicket extends Schema.CollectionType {
  ...
  attributes: {
    ...
    status: Attribute.Enumeration<
      ['success', 'error', 'pending', 'Active', 'Inactive']
    > &
...
export interface ApiTransactionTransaction extends Schema.CollectionType {
  ...
  attributes: {
    ...
    producer: Attribute.Relation<
      ...
      'api::producer.producer'
    >;
    status: Attribute.Enumeration<['success', 'error', 'pending']> &
      Attribute.DefaultTo<'pending'>;
    payment_method: Attribute.Enumeration<['Prometeo', 'Bamboo']>;
    user: Attribute.Relation<
      'api::transaction.transaction',
      'oneToOne',
      'plugin::users-permissions.user'
...
export interface ApiWithdrawWithdraw extends Schema.CollectionType {
  ...
  attributes: {
    ...
    nro_cuenta: Attribute.String;
    status: Attribute.Enumeration<['Aprobado', 'Pendiente', 'Rechazado']>;
    amount: Attribute.Decimal;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
